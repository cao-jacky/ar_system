...
def performDetect(imagePath="data/test.jpg", thresh= 0.25, configPath = "./cfg/yolov3-tiny.cfg", weightPath = "yolov3-tiny.weights", metaPath= "./cfg/coco.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
    ...
    print("process took", time.perf_counter()-before_time)
    if showImage:
        try:
